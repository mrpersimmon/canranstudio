(function (root) {
  ...
  const help = {
    ...
    roles: ['先听完故事，再来找答案。需要回顾时可以回到衣帽间小剧场。'],
    words: ['点整张词卡听发音、看意思。用上一组和下一组翻页。'],
    listen: ['先点喇叭，再选出听到的单词。录音听完才可以检查，随时可以重听。'],
    phrases: ['点表达卡听一听，再到下一站试着使用。'],
    ask: ['看人物或物品和题目，选出对应的问句。'],
    reply: ['先听一句话，再试着换人说话、拼出回答并判断未知归属。先判断谁在说话、物品是谁的；不知道的归属不猜。'],
  ...
  stage.append(actor('visitor', '客人'), log, actor('attendant', '工作人员'));
  ...
  mountPractice('manners'); mountPractice('ask', { presentation: 'question' }); mountPractice('reply'); mountPractice('trans');
  ...
  certificateView = core.unitCertificate.mount({
    ...
    design: {
      copy: { title: '认领小达人', course: '雨伞认领小帮手 · Lesson 3–4', completion: '完成 Lesson 3–4 单元练习', thanks: '仔细确认，礼貌认领！' },
