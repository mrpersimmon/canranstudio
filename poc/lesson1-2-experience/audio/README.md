...
- `starlight-station-ambience.mp3` is a deterministic original procedural tone bed generated by `scripts/build-starlight-station-ambience.mjs`. It contains no sampled music, remains an unreviewed placeholder, and is off by default until the child explicitly enables background music.
