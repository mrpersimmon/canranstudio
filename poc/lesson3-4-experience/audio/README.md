# Lesson 3–4 audio used by the current cat learning path
...
- The files are AI-generated candidates used by the published cat learning path. They are not official textbook audio. Per-file human language and child-listening acceptance remains incomplete; publication status and audio acceptance are recorded separately in the V4 QA and publication documents.
