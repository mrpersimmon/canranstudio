...
test('每个课程入口和资源都留在 lesson 下，原版记录不被重开操作删除', async ({ page }) => {
  ...
  expect(entries.map(entry => new URL(entry.href).pathname)).toEqual([
    '/lesson/unit1-2/', '/lesson/unit3-4/', '/lesson/unit5-6/', '/lesson/unit7-8/', '/lesson/unit9-10/', '/lesson/unit11-12/', '/lesson/unit13-14/', '/lesson/unit15-16/', '/lesson/unit17-18/', '/lesson/unit19-20/', '/lesson/unit21-22/', '/lesson/unit23-24/', '/lesson/unit25-26/', '/lesson/unit27-28/', '/lesson/unit29-30/', '/lesson/unit49-50/',
