...
const ANSWERS={listen:["成年女子", "胖的", "thin", "高的", "short", "dirty", "clean", "hot", "冷的；觉得冷的", "年老的", "young", "busy", "懒惰的；不愿付出努力"],roles:["She's very well.",'Steven','Tony'],reply:["I'm fine, thanks.",'Nice to see you, too.'],describe:["He's","It's","She's busy."],trans:[["I'm",'fine,','thanks.','And','you?'],['Look at','Emma.',"She's",'cold.']],exam:['Tony · fine','他不觉得冷',['Look at','that umbrella.',"It's",'dirty.']]};
...
async function completeUnit910(page,base=""){await completeActivity(page,'listen',base);await completeStory(page,base);for(const id of ['roles','reply','describe','trans','exam'])await completeActivity(page,id,base);await page.goto(base+'/unit9-10/#learn/certificate');await expect(page.locator('#starCount')).toHaveText('15');}
