(function (root) {
  ...
  const help = {
    ...
    roles: ['先听完故事，再来找答案。需要回顾时可以回到认领小剧场。'],
    ...
    models: ['点画卡听如何问主人、用名字或 his／her 回答。完整替换组可以自由点读。'],
  ...
  function playLine(index) {
    ...
    stage.querySelector('[data-actor="' + line.person + '"]').classList.add('speaking');
  ...
  certificateView = core.unitCertificate.mount({
    ...
    design: {
      copy: { title: '归还小能手', course: '失物招领小侦探 · Lesson 11–12', completion: '完成 Lesson 11–12 单元练习', thanks: '细心找线索，问清楚，让物品回到主人身边！' },
  ...
  writing.append(node('summary','和朋友再试试'),node('p','用物品卡扮演老师和同学：先问是谁的，确认后再交给对方。练习说 my／your／his／her 时交换说话人；用虚构家庭卡练习，不必披露自己的家庭情况。'));
