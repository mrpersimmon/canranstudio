...
const ANSWERS={listen:['意大利（人）的','keyboard operator','工程师','policeman','policewoman','taxi driver','女空乘','postman','nurse','机械师；修理机器的人','hairdresser','家庭主妇','milkman'],roles:["I'm an engineer.","No, she isn't."],reply:["I'm Italian.",'is / am','is / is'],interview:["What's his job?","What's her job?",["What's",'your job?',"I'm",'an engineer.'],['Is','he','a taxi driver?','Yes,','he is.']],exam:['意大利人；护士','Are you a mechanic?',['My',"name's",'Ben.',"I'm",'an engineer.']]};
