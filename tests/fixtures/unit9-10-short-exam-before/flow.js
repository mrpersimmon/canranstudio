...
const ANSWERS={listen:["成年女子", "胖的", "thin", "高的", "short", "dirty", "clean", "hot", "冷的；觉得冷的", "年老的", "young", "busy", "懒惰的；不愿付出努力"],roles:["She's very well.",'Steven','Tony'],reply:["I'm fine, thanks.",["I'm",'fine,','thanks.','And','you?'],'Nice to see you, too.'],describe:["He's","It's","She's busy.",['Look at','Emma.',"She's",'cold.']],exam:['Tony · fine','他不觉得冷',['Look at','that umbrella.',"It's",'dirty.']]};
